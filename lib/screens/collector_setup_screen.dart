...
class CollectorSetupScreen extends StatefulWidget {
  ...
  const CollectorSetupScreen({super.key, required this.uid, required this.firstName});
                    ...
                    child: Form(
                      ...
                      child: ListView(
                        children: [
                          ...
                          _field(_collectionZoneCtrl, s.collectionZone, Icons.location_on_outlined, s),
                          const SizedBox(height: 18),

                          Text(s.workStatusQuestion,
                              style: const TextStyle(
                                  fontSize: 12.5, fontWeight: FontWeight.w700, color: AppColors.greenDark)),
                            ...
                            children: [
                              Expanded(
                                child: _choiceChip(
                                  ...
                                  () => setState(() => _workStatus = WorkStatus.independent),
                                ),
                              ),
                              ...
                              Expanded(
                                child: _choiceChip(
                                  ...
                                  () => setState(() => _workStatus = WorkStatus.company),
                                ),
                              ),
                            ],
                          ),
                          ...
                          _isLoading
                              ...
                              : GradientPillButton(label: s.finish, onPressed: () => _finish(s)),
      ...
      child: Container(
        ...
        child: Text(
          ...
          style: TextStyle(
            ...
            color: active ? AppColors.greenDark : AppColors.textGray,
          ),
        ),
      ),
    );
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          const SizedBox(width: 8),
          Expanded(
            child: Text(text, style: const TextStyle(fontSize: 11.5, color: AppColors.greenDark, height: 1.4)),
          ),
        ],
      ),
    );
