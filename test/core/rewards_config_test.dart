...
void main() {
  group('RewardsConfig', () {
    test('chaque catégorie a un barème de points et un prix', () {
    ...
    test('15 points valent 500 FCFA', () {
    ...
    test('points d\'une collecte = points/kg × poids', () {
    ...
    test('valeur d\'une collecte = prix/kg × poids', () {
    ...
    test('le barème détaillé dérive du même taux de conversion', () {
